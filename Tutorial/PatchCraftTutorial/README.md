...
`masterclass.html` is the main long-form tutorial intended for the website and
future video scripts. It covers the complete PatchCraft workflow: Workflow,
Design, Sample Mapper, One Shot Maker, MIDI Playground, DSP Builder, Build,
Brand Lab, Launch, Player runtime, build recipes, selling strategy, and
troubleshooting.
