    ...
    namespace
    {
        ...
        static const std::vector<ProgressionPreset>& progressionPresets()
        {
            static const std::vector<ProgressionPreset> presets {{
                ...
                { "Trap Minor Bounce", 2, 17, 4, 0.50f, {{ 0.0f, 8.0f, 10.0f, 7.0f }}, {{ 12.0f, 15.0f, 17.0f, 14.0f }}, 5, 0.38f, 0.08f, 0.02f, 0.03f },
                { "Boom Bap Soul Loop", 2, 22, 4, 0.56f, {{ 0.0f, 3.0f, 5.0f, 10.0f }}, {{ 14.0f, 15.0f, 17.0f, 22.0f }}, 2, 0.62f, 0.16f, 0.16f, 0.07f },
                { "R&B Seventh Turnaround", 1, 25, 5, 0.72f, {{ 9.0f, 2.0f, 7.0f, 0.0f }}, {{ 16.0f, 14.0f, 18.0f, 21.0f }}, 2, 0.70f, 0.10f, 0.22f, 0.05f },
                { "Afrobeats Sunshine", 1, 12, 4, 0.54f, {{ 0.0f, 7.0f, 9.0f, 5.0f }}, {{ 12.0f, 14.0f, 16.0f, 12.0f }}, 5, 0.46f, 0.06f, 0.04f, 0.03f },
                { "House Piano Lift", 1, 1, 4, 0.44f, {{ 0.0f, 5.0f, 9.0f, 7.0f }}, {{ 12.0f, 17.0f, 21.0f, 19.0f }}, 4, 0.40f, 0.04f, 0.03f, 0.02f },
                { "Drill Tension", 4, 28, 4, 0.46f, {{ 0.0f, 1.0f, 8.0f, 6.0f }}, {{ 10.0f, 13.0f, 20.0f, 18.0f }}, 6, 0.32f, 0.03f, 0.01f, 0.02f },
                { "Jazzy ii V Turnaround", 1, 21, 4, 0.68f, {{ 2.0f, 7.0f, 0.0f, 9.0f }}, {{ 14.0f, 18.0f, 16.0f, 21.0f }}, 2, 0.66f, 0.12f, 0.20f, 0.05f },
                { "Latin Pop Rise", 1, 1, 3, 0.34f, {{ 0.0f, 5.0f, 7.0f, 4.0f }}, {{ 12.0f, 17.0f, 19.0f, 16.0f }}, 5, 0.44f, 0.05f, 0.05f, 0.03f },
                { "Epic Modal Shift", 3, 16, 5, 0.70f, {{ 0.0f, 2.0f, 7.0f, 10.0f }}, {{ 14.0f, 16.0f, 19.0f, 22.0f }}, 1, 0.72f, 0.02f, 0.18f, 0.04f },
                { "LoFi Neo Soul Pocket", 2, 25, 5, 0.66f, {{ 0.0f, 10.0f, 3.0f, 5.0f }}, {{ 14.0f, 22.0f, 15.0f, 17.0f }}, 2, 0.58f, 0.20f, 0.18f, 0.08f }
            }};
            return presets;
        }
    }
